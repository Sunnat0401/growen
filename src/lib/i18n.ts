...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Disease Discovery Tool",
      description:
        "Advanced AI-powered platform for detecting and diagnosing plant and animal diseases with precision and speed",
      cta: "Get Started",
      learnMore: "Learn More",
    },
    detection: {
    ...
    howItWorks: {
      ...
      step1: {
        title: "Upload Image",
        description:
          "Take or upload a clear photo of the affected plant or animal",
      },
      step2: {
        title: "AI Analysis",
        description: "Our advanced AI analyzes the image for disease patterns",
    ...
    features: {
      ...
      comprehensive: {
        title: "Comprehensive Database",
        description:
          "Access to extensive disease database for plants and animals",
      },
    },
    faq: {
      title: "Frequently Asked Questions",
      q1: {
        question: "How accurate is the disease detection?",
        answer:
          "Our AI model achieves over 95% accuracy in detecting common plant and animal diseases, continuously improving through machine learning.",
      },
      q2: {
        question: "What types of diseases can be detected?",
        answer:
          "We can detect a wide range of diseases including fungal infections, bacterial diseases, viral infections, and nutrient deficiencies in plants and common diseases in livestock and pets.",
      },
      q3: {
        question: "Is my data secure?",
        answer:
          "Yes, all uploaded images and data are encrypted and securely stored. We respect your privacy and never share your information with third parties.",
      },
    },
    footer: {
      description:
        "Advanced AI-powered platform for agricultural disease detection",
      rights: "All rights reserved.",
      links: {
      ...
      policies: {
        privacy:
          "We respect your privacy. Your data is used only to improve Growen services and for research purposes. It will never be shared with third parties.",
        terms:
          "By using Growen, you agree to our terms. AI results are for informational purposes only.",
        support:
          "Contact us for questions:\nEmail: support@growen.ai\nPhone: +998 90 123 45 67",
        delete:
          "To delete your account or data, please contact us at: privacy@growen.ai.",
      },
    },
    contact: {
      title: "Contact Us",
  ...
  ru: {
    ...
    hero: {
      ...
      subtitle: "Инструмент обнаружения болезней",
      description:
        "Продвинутая платформа с искусственным интеллектом для точного и быстрого обнаружения и диагностики болезней растений и животных",
      cta: "Начать",
      learnMore: "Узнать больше",
    },
    detection: {
    ...
    howItWorks: {
      ...
      step1: {
        title: "Загрузите фото",
        description:
          "Сделайте или загрузите четкое фото пораженного растения или животного",
      },
      step2: {
        title: "Анализ ИИ",
        description:
          "Наш продвинутый ИИ анализирует изображение на предмет признаков болезни",
      },
      step3: {
        title: "Получите результаты",
        description: "Получите подробный диагноз и рекомендации по лечению",
    ...
    features: {
      ...
      accuracy: {
        title: "Высокая точность",
        description:
          "Наша модель ИИ обучена на миллионах изображений для точного обнаружения",
      },
      speed: {
        title: "Быстрые результаты",
        description: "Мгновенный анализ и рекомендации за считанные секунды",
      ...
      comprehensive: {
        title: "Обширная база данных",
        description:
          "Доступ к обширной базе данных болезней растений и животных",
      },
    },
    faq: {
      title: "Часто задаваемые вопросы",
      q1: {
        question: "Насколько точно обнаружение болезней?",
        answer:
          "Наша модель ИИ достигает точности более 95% в обнаружении распространенных болезней растений и животных, постоянно улучшаясь благодаря машинному обучению.",
      },
      q2: {
        question: "Какие типы болезней можно обнаружить?",
        answer:
          "Мы можем обнаружить широкий спектр заболеваний, включая грибковые инфекции, бактериальные болезни, вирусные инфекции и дефицит питательных веществ у растений, а также распространенные болезни у скота и домашних животных.",
      },
      q3: {
        question: "Безопасны ли мои данные?",
        answer:
          "Да, все загруженные изображения и данные зашифрованы и надежно хранятся. Мы уважаем вашу конфиденциальность и никогда не передаем вашу информацию третьим лицам.",
      },
    },
    footer: {
      description:
      ...
      policies: {
        privacy:
          "Мы ценим конфиденциальность пользователей. Ваша информация используется только для улучшения сервисов Growen и научных целей. Не передаётся третьим лицам.",
        terms:
          "Используя сервис Growen, вы соглашаетесь с нашими условиями. Результаты ИИ предоставляются только в ознакомительных целях.",
        support:
          "Свяжитесь с нами по вопросам:\nEmail: support@growen.ai\nТелефон: +998 90 123 45 67",
        delete:
          "Чтобы удалить свой аккаунт или данные, напишите нам на: privacy@growen.ai.",
      },
    },
    contact: {
      title: "Связаться с нами",
  ...
  uz: {
    ...
    hero: {
      ...
      subtitle: "Kasalliklarni aniqlash vositasi",
      description:
        "O'simliklar va hayvonlar kasalliklarini aniq va tez aniqlash va tashxis qilish uchun sun'iy intellekt asosidagi ilg'or platforma",
      cta: "Boshlash",
      learnMore: "Ko'proq o'rganish",
    },
    detection: {
    ...
    howItWorks: {
      ...
      step1: {
        title: "Rasm yuklang",
        description:
          "Zararlangan o'simlik yoki hayvonning aniq rasmini oling yoki yuklang",
      },
      step2: {
        title: "AI tahlili",
        description:
          "Bizning ilg'or sun'iy intellektimiz kasallik belgilari uchun rasmni tahlil qiladi",
      },
      step3: {
        title: "Natijalarni oling",
        description: "Batafsil tashxis va davolash bo'yicha tavsiyalar oling",
    ...
    features: {
      ...
      accuracy: {
        title: "Yuqori aniqlik",
        description:
          "Bizning AI modelimiz aniq aniqlash uchun millionlab tasvirlar asosida o'rgatilgan",
      },
      speed: {
        title: "Tez natijalar",
        description: "Bir necha soniyada oniy tahlil va tavsiyalar oling",
      ...
      comprehensive: {
        title: "Keng qamrovli ma'lumotlar bazasi",
        description:
          "O'simliklar va hayvonlar kasalliklari bo'yicha keng qamrovli ma'lumotlar bazasiga kirish",
      },
    },
    faq: {
      title: "Tez-tez so'raladigan savollar",
      q1: {
        question: "Kasalliklarni aniqlash qanchalik aniq?",
        answer:
          "Bizning AI modelimiz umumiy o'simliklar va hayvonlar kasalliklarini aniqlashda 95% dan ortiq aniqlikka erishadi va mashinali o'rganish orqali doimiy ravishda yaxshilanadi.",
      },
      q2: {
        question: "Qanday turdagi kasalliklarni aniqlash mumkin?",
        answer:
          "Biz qo'ziqorin infektsiyalari, bakterial kasalliklar, virusli infektsiyalar va o'simliklarning ozuqa moddalar tanqisligi hamda chorva mollari va uy hayvonlaridagi keng tarqalgan kasalliklarni aniqlashimiz mumkin.",
      },
      q3: {
        question: "Ma'lumotlarim xavfsizmi?",
        answer:
          "Ha, barcha yuklangan rasmlar va ma'lumotlar shifrlangan va xavfsiz saqlanadi. Biz sizning maxfiyligingizni hurmat qilamiz va hech qachon ma'lumotlaringizni uchinchi shaxslarga bermаymiz.",
      },
    },
    footer: {
      description:
      ...
      policies: {
        privacy:
          "Biz foydalanuvchilarning maxfiyligini qadrlaymiz. Sizning ma'lumotlaringiz faqat Growen xizmatlarini yaxshilash va ilmiy maqsadlarda ishlatiladi. Uchinchi tomonlarga berilmaydi.",
        terms:
          "Growen xizmatlaridan foydalanish orqali siz bizning qoidalarimizga rozilik bildirasiz. AI natijalari faqat maslahat sifatida taqdim etiladi.",
        support:
          "Savollar uchun biz bilan bog'laning:\nEmail: support@growen.ai\nTelefon: +998 90 123 45 67",
        delete:
          "Hisobingizni yoki ma'lumotlaringizni o'chirish uchun iltimos bizga yozing: privacy@growen.ai.",
      },
    },
    contact: {
      title: "Biz bilan bog'laning",
